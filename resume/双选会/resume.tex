...
\section{教育经历}
\cventry{12.09-16.07}{本科}{广州大学}{数学与信息科学学院}{信息安全}{}         % arguments 3 to 6 are optional
\cventry{17.09- 至今}{硕士}{西安电子科技大学}{网络与信息安全学院}{网络空间安全}{}    
\section{项目经历}
...
\section{证书获奖}
\cvline{13.09-17.09}{ 学校奖学金、普通话二级甲等、CET6、IELTS5.5...}
\cvline{17.09-18.09}{ 专业课成绩前10\%、一等奖学金、优秀研究生称号 }    
\cvline{18.04-18.06}{ 第四届“互联网+创新创业大赛”金奖：基于区块链支持模糊去重的完整性审计系统}
\cvline{(参与)}{数据加密+重复数据删除+数据完整性验证+区块链智能合约}      
\cvline{18.10-19.01}{ 研究生学术年会论文二等奖 }
\section{工作技能}
\cvline{}{无障碍阅读英文；密码学基础；云存储安全；区块链基础；实现论文方案的能力}
\cvline{}{网络原理和安全，熟悉HTTP(S)、TCP/IP}
\cvline{}{HTML、Markdown、Latex、Office}
\cvline{}{熟悉常用的命令行工具，熟练掌握Shell、Python语言编程}
\section{科研成果}
\cvline{论文,已发表}{\textbf{Zhao, Y.,} Yuan, H., Jiang, T., Chen, X., \href{https://doi.org/10.1016/j.jisa.2019.04.003} {Secure Distributed Data Geolocation Scheme Against Location Forgery Attack}, \emph{Journal of Information Security and Applications}, (CCF C类)}
