...
\familyname{}
\title{Yinyuan Zhao}   
\address{1994/04/25}{}    % optional, remove the line if not wanted
...
\cvline{ }{实现一个B/S 架构的云存储系统，服务器实时广播证明，分布式节点合作检测延迟}
\cvline{Blockchain}{区块链安全性研究，梳理调研区块链各层结构漏洞和威胁}
\cvline{}{密码学与隐私保护、P2P与广播、51\%攻击、合约虚拟机、挖矿木马......}
\section{证书获奖}
\cvline{13.09-17.09}{ 学校奖学金，普通话二级甲等，CET6...}
...
\cvline{网络}{网络原理和安全，熟悉HTTP(S)、TCP/IP}
\cvline{开发}{熟悉常用的命令行工具，熟练掌握Shell、Python、C语言编程}
\section{科研成果}
\cvline{论文,已发表}{\textbf{Zhao, Y.,} Yuan, H., Jiang, T., Chen, X., \href{https://doi.org/10.1016/j.jisa.2019.04.003} {Secure Distributed Data Geolocation Scheme Against Location Forgery Attack}, \emph{Journal of Information Security and Applications}(SCI)}
...
\cvline{}{密码学，安全背景，基础知识}
\cvline{性格}{学习能力强，有责任心，善于沟通交流}
\cvline{}{适应能力强，持之以恒（扇贝单词无间断打卡1200+天）}
